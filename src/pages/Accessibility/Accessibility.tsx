    ...
    <MainContent>
      <Styled.PageContent>
        ...
        <Styled.Section>
          ...
          <Text as="h3" bold colour="charcoal" mb="small" mt="medium">
            Keyboard navigation
          </Text>
          <Text as="p" mb="small">
        ...
        <Styled.Section>
          ...
          <Text as="p" mt="small">
            ...
            browsers. It can be installed to your home screen and continues to
            work offline after your first visit.
          </Text>
        </Styled.Section>
